...
export default function DashboardHeader({ line1, line2, userId, profileType = 'venue', gradient: gradientOverride }) {
    ...
    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 24 }}>
      ...
      {userId && (
        <button
          ...
          onClick={() => navigate(`/profile/${userId}?type=${profileType}`)}
