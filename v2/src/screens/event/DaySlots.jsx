        ...
        {effectiveIsHost && showEditor ? (
            ...
            <SortableContext items={sortableIds} strategy={verticalListSortingStrategy}>
              {slots.map((slot, si) => (
                <SlotCard key={slot.id} slot={slot} claim={claims[slot.id]}
                  ...
                  onEdit={!isLocked ? () => onEdit(di, si, slot) : null}
                  onRemove={!isLocked ? () => onRemove(slot) : null}
                  onPin={!isLocked ? () => onPin(di, si) : null}
          ...
          slots.map((slot, si) => (
            <SlotCard key={slot.id} slot={slot} claim={claims[slot.id]}
              ...
              onEdit={effectiveIsHost && !isLocked ? () => onEdit(di, si, slot) : null}
              onRemove={effectiveIsHost && !isLocked ? () => onRemove(slot) : null}
              onPin={effectiveIsHost && !isLocked ? () => onPin(di, si) : null}
              allMixSlots={allMixSlots}
            />
          ))
        )}
