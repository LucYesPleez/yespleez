...
function loadProfileData() {
  ...
  const ftlEl = document.getElementById('profileFeePlusTravelLocal'), fnEl = document.getElementById('profileFeeNegotiable');
  if (ftlEl) ftlEl.checked = !!artistProfile.feePlusTravelLocal; if (fnEl) fnEl.checked = !!artistProfile.feeNegotiable;
