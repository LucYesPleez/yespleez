 ...
 *
 * ⭐ THE LIST IS DERIVED FROM THE TABLE, ⛔ not hand-written: 84 columns minus
 * the 10 private ones. A hand-typed list silently drops whatever it forgets,
 * and the failure mode is a blank field on a public page rather than an error.
 *
...
export const PUBLIC_PROFILE_COLUMNS = Object.freeze([
  ...
  'soundcloud', 'source', 'spotify', 'stage_dims', 'state', 'studio_local_id',
