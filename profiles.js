...
function openPublicProfile(row) {
  ...
  document.getElementById('publicProfileContent').innerHTML = `
    ...
    <div style="text-align:center;margin-bottom:20px;">
      ...
      ${isHost && row.years ? `<div style="margin-top:6px;"><span style="font-family:'Bebas Neue',sans-serif;font-size:13px;letter-spacing:2px;color:#fff;">EST. ${row.years}</span></div>` : ''}
    </div>
    ${mixHtml}
