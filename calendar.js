...
function calSlimDayCard(ev) {
  ...
  return `<div onclick="calOpenEvent('${ev.id}')" style="border-radius:14px;overflow:hidden;cursor:pointer;border:1px solid #00e676;position:relative;height:calc((100dvh - 300px) / 7);min-height:70px;background:${bg};touch-action:manipulation;flex-shrink:0;">
